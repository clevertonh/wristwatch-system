...
<div>
	<p>Relatório que fornecerá uma listagem dos relógios cadastrados com o preço mais baixo.</p>
</div>
...
<form class="form-signin" action="${pageContext.servletContext.contextPath}/lower-price/Analysis" method="GET">
	<h2 class="form-signin-heading">Maiores preços</h2>

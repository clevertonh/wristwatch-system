...
<% String error = (String) request.getSession().getAttribute("error"); %>
	...
	<c:if test="${error != null}">
      ...
      <form action="${pageContext.servletContext.contextPath}/sale/create" method="POST">
          <h2 class="form-signin-heading">Informe os dados cadastrais da empresa de venda do relógio</h2>
           <div class="form-group">
			    <label for="inputID">ID do Relógio*</label>
			    <input type="number" name="id" class="form-control" id="inputID" placeholder="Identificação" required>
	 	  </div>
